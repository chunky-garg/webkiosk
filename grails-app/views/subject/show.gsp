	...
	<body>
		...
		<div id="show-subject" class="content scaffold-show" role="main">
			...
			<ol class="property-list subject">
				...
				<g:if test="${subjectInstance?.code}">
				<li class="fieldcontain">
					<span id="code-label" class="property-label"><g:message code="subject.code.label" default="Code" /></span>
					
						<span class="property-value" aria-labelledby="code-label"><g:fieldValue bean="${subjectInstance}" field="code"/></span>
