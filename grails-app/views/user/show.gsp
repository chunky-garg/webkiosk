	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.doj}">
				<li class="fieldcontain">
					<span id="doj-label" class="property-label"><g:message code="user.doj.label" default="Doj" /></span>
					
						<span class="property-value" aria-labelledby="doj-label"><g:formatDate date="${userInstance?.doj}" /></span>
				...
				<g:if test="${userInstance?.dpName}">
				<li class="fieldcontain">
					<span id="dpName-label" class="property-label"><g:message code="user.dpName.label" default="Dp Name" /></span>
					
						<span class="property-value" aria-labelledby="dpName-label"><g:fieldValue bean="${userInstance}" field="dpName"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${userInstance?.category}">
				<li class="fieldcontain">
					<span id="category-label" class="property-label"><g:message code="user.category.label" default="Category" /></span>
					
						<span class="property-value" aria-labelledby="category-label"><g:fieldValue bean="${userInstance}" field="category"/></span>
